...
context('crowdStreet signup process', function() {
    ...
    it('Verify account is created', function() {
        ...
        cy.get('#content-well > div.content.-accounts > div > div > div.css-pqgn5f.e9fk5m11.sc-bdVaJa.gqHuFm > div > div > div.account-creation-form-container.sc-bdVaJa.hgkmdP > button').click({force:true});
